            ...
            <?php
              ...
              {  
                  ...
                  echo '<tr align="center">';
                    ...
                    echo '<td><font size="2px"><a href="index.php?page=hadir&&nimnik='.$data['nimnik'].'&&idkelas='.$data1['idkelas'].'&&nim='.$data1['nim'].'" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-edit"></span> Detail </a></font></td>';
